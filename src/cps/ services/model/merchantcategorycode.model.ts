...
MerchantCategoryCodeSchema.pre<MerchantCategory>('save', function preSaveMiddleware (next) {
...
const merchantCategoryCodeModel = modules.mongoose.model<MerchantCategory, PaginateModel<MerchantCategory>>(
  'MerchantCategoryCode',
  MerchantCategoryCodeSchema
)
