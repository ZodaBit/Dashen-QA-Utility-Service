...
const archiveLinkedAccountModel: Model<LinkedAccount> =
    mongoose.model<LinkedAccount>('ArchiveLinkedAccount', LinkedAccountSchema);


export default archiveLinkedAccountModel;